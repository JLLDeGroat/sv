...
public:
	...
	void OnGunPreFireActivate();
	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void OnGunPostFireDeactivate();
	...
	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void OnUnholsteredWeapon();
	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void OnGrabbedThrowable();
	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void OnReleasedThrowable();
	...
	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void OnFinishSkippable();

	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void OnFinishTakenDamage();

	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void OnInitializePickup();
	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void OnFinishPickup();
	...
	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void SpawningFromGroundStartMovingUp();
	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void SpawningFromGroundFinishMovingUp();
	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void SpawningFromGroundAlterMovingUpSpeed(float speed);

	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void OnHolsterCurrentWeapon();
	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void OnUnHolsterNewWeapon();
	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void OnFinishWeaponSwapping();

	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void OnHealingComplete();

	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void OnSpawnHealthKit();
	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void OnDespawnHealthKit();
	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void SetHealthKitActivation(bool val);

	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void OnSuicideExplosion();

	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void OnClimbGoUp();
	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void OnClimbPauseGoUp();
	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void OnClimbFinish();
	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void OnPostClimbStart();

	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void OnClimbPreFall();
	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void OnClimbFallStart();
	UFUNCTION(BlueprintCallable, meta = (BlueprintThreadSafe))
	void OnClimbFallStop();
...
protected:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere)
	ECharacterAnimState CharacterAnimState;
	UPROPERTY(BlueprintReadWrite, EditAnywhere)
	float AnimPlayRate;
