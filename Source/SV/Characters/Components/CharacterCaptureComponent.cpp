...
UCharacterCaptureComponent::UCharacterCaptureComponent(const FObjectInitializer& ObjectInitializer) :
...
void UCharacterCaptureComponent::SetToRenderTargetNumber(int renderTargetNumber) {
	...
	else UDebugMessages::LogError(this, "FAILED: to Set Render target");
}
